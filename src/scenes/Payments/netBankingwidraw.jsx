...
export default function NetBankingForm() {
  ...
  const handleTextField1Change = (event) => {
    ...
    compareFields(event.target.value, textField2);
  };

  const handleTextField2Change = (event) => {
    setTextField2(event.target.value);
    compareFields(textField1, event.target.value);
  };

  const compareFields = (value1, value2) => {
    if (value1 === value2) {
      console.log('Strings/Numbers Match');
    } else {
      console.log('Strings/Numbers Do Not Match');
    }
  };
  ...
  const themes = createTheme({
    palette: {
      primary: {
        main: '#000', // Set primary color to green
      },
    },
  });
    ...
    <div >
      <ThemeProvider theme={themes}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={6}>
      <FormControl sx={{ width: '43.5ch' }} size="small" fullWidth variant="outlined">
        {/* <InputLabel htmlFor="outlined-adornment-password">Confirm Account Number</InputLabel> */}
        <TextField
          fullWidth
      ...
      <FormControl sx={{ width: '43.5ch' }} size="small" fullWidth variant="outlined">
        ...
        />
          ...
          <Grid item xs={6}>
            <TextField id="outlined-basic" size="small" label="IFSC Code" variant="outlined" fullWidth />
          </Grid>
          <Grid item xs={6}>
            <TextField id="outlined-basic" size="small" label="Branch Code" variant="outlined" fullWidth />
          </Grid>
          <Grid item xs={6}>
            <Autocomplete
