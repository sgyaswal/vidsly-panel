...
const Payments = () => {
  ...
  const [facebookEarning, setFacebookEarning] = useState("");
  const [totalEarnings, setTotalEarnings] = useState(null);

  let token, staff, parsedData, userId;
  ...
  console.log(userId,"user_iddddd");
  ...
  const GetAllEarnings = async (id) => {
    try {
      ...
      setInstagramEarning(responseData?.data?.instagram_earning);
      setFacebookEarning(responseData?.data?.facebook_earning);
      setYoutubeEarning(responseData?.data?.youtube_earning);
      setTotalEarnings(responseData?.data?.total_earning);
  ...
  return (
    <div>
      {/* <Box m="20px"> */}
      <Box
        sx={{ position: "fixed", height: "calc(100vh - 20px)", width: "80vw" }}
      >
        <Box
          sx={{
        ...
        >
          ...
          >
            <Header
              ...
              subtitle="Welcome to your payments and earnings"
            />
          </Box>
            ...
            <div className="button-flexing">
              <div style={{ backgroundColor: "#19875" }}>
                {Staff === true ? (
                  ...
                  <button className="withdrawl-button" onClick={handleOpen}>
                    Bank Transfer
                  </button>
                )}
